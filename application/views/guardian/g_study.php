              ...
              <div class="panel-body">
            	...
            	<table class="table table-responsive">
                  <thead>
            		...
            		<tbody>
            			<?php
           		//assign the learner id to the search variable
                $search['learner']=$luID;
                //query the study material using the learner id
                //to bring all the notes for all subjcts of the learner
                 $all_learner_material=$this->material->getStudyMaterial($search);
                ...
                if (!empty($all_learner_material)) {
                    ...
                    if (!empty($learner_study)) {
                      foreach ($learner_study as $learnerMaterial) { 
                        //if ($childSubj->clsID == $learnerMaterial->clsID) { 
                 		...
                 		<tr >
                    		...
                    		<a href="#"
                                ...
                                <span class="glyphicon glyphicon-folder-open text-primary" style="color:green"></span>
