...
class Ajax_pagination{
    ...
    var $per_page        = ITEMS_PER_PAGE; // Max number of items you want shown per page
    ...
    var $show_count      = FALSE;//shows from item to item that the user is seeing
    var $link_func       = 'getData';//default name for the ajax call function
    var $loading         = '.loading';// default loading image
    ...
    function create_links(){
        ...
        function <?=$this->link_func?>(page){ 
            //this is to able a search with pagination
        if($('<?php echo $this->targetSearch; ?>').val()) {var search=$('<?php echo $this->targetSearch; ?>').val();
        form_data = {page: page,srchMgs:search};
        }else{
        form_data = {page: page};
        }
         //end this is to able a search with pagination    
            $.ajax({
                method: "POST",
                ...
                success: function(data){
                    ...
                    if(search !== 'undefined'){
                     $('<?php echo $this->targetSearch; ?>').val(search);
                    }
            },
            });
        }
